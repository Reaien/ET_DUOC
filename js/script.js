...
const validarFormulario = (e) => {
    switch (e.target.name) {
        ...
        case "apellidom":
            if (expresiones.nombre.test(e.target.value)) {
                document.getElementById('grupo__apmaterno').classList.remove('formulario__grupo-incorrecto');
                document.getElementById('grupo__apmaterno').classList.add('formulario__grupo-correcto');
                document.querySelector('#grupo__apmaterno .formulario__input-error').classList.remove('formulario__input-error--activo');
            }else{
                document.getElementById('grupo__apmaterno').classList.remove('formulario__grupo-correcto');
                document.getElementById('grupo__apmaterno').classList.add('formulario__grupo-incorrecto');
                document.querySelector('#grupo__apmaterno .formulario__input-error').classList.add('formulario__input-error--activo');
            }
            break;
        case "edad":
